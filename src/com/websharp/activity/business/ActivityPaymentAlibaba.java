...
public class ActivityPaymentAlibaba extends BaseActivity {
	...
	public void initLayout() {
		// TODO Auto-generated method stub
		setContentView(R.layout.activity_pay_alibaba);
	}
	...
	private void queryPayResult() {
		new SwzfHttpHandler(cbPayAlipay, ActivityPaymentAlibaba.this).queryPayAlipay(tradeID);
	}
			...
			try {
				...
				if (obj.optInt("code") == 0) {
					if (obj.getJSONObject("data").optInt("PayState") == 0) {
						handler.removeMessages(0);
						Util.createToast(ActivityPaymentAlibaba.this, "支付成功!", Toast.LENGTH_LONG).show();
						...
						sendBroadcast(new Intent(Constant.ACTION_HIDE_FRAGMENT));
						Util.createToast(ActivityPaymentAlibaba.this, "支付失败!", Toast.LENGTH_LONG).show();
						finish();
